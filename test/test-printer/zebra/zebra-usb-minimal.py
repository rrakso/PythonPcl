...
def print_minimal_doc(idVendor, idProduct, encoding):
    ...
    d.field(origin=(120, 11), font=d.font("E"), data="Hello")
    d.field(origin=(120, 42), font=d.font("E"), data="Wolrd!")
    d.field(origin=(100, 160), font=d.font("C"), data="Label print demo")
    d.field(origin=(70, 180), font=d.font("C"), data="Using PythonPCL package")
