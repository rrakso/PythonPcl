...
def print_hmi_demo(printer_socket):
    ...
    d.writeln("This is a demo about the usage of VMI")
    d.writeln("and how it can impact your print out")
    d.writeln()

    d.vertical_motion_index(6)  # Set the value to 8 lines/inch
    # 84 lines-per-page
    d.writeln("But this better to have a proper value")
    d.writeln("when printing stuff")
